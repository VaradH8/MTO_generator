...
export default function OutputPage() {
  ...
  const { groupedSupports, validationResult, billingRecorded, loaded, setValidationResult, setGroupedSupports, setBillingRecorded } = useSupportContext()
  ...
  useEffect(() => {
    if (!loaded || billingRecorded || !groupedSupports || !validationResult) return
    setBillingRecorded(true)
  ...
  }, [loaded, billingRecorded, groupedSupports, validationResult, addEntry, setBillingRecorded])
